...
RESEARCH_POLICY = (
    ...
    'Working notes are already in context.history. If needed use bits-memory show --notes-only, '
    ...
    'Use graphify query for scoped code navigation. Reserve action budget to save findings and next steps. '
