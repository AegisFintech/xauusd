...
def main():
 ...
 ops=sub.add_parser("operations"); ops.add_argument("action",choices=["health","backup","verify-backup","compact-artifacts","artifact-retention-inventory","scaling-checkpoint","capture-scaling-checkpoints","remote-artifacts-plan","remote-artifacts-apply","remote-artifacts-reconcile"]); ops.add_argument("--plan"); ops.add_argument("--digest"); ops.add_argument("--journal"); ops.add_argument("--root")
