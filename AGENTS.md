...
Bits latency and offline SDK/official-documentation findings. Broker ID mapping (#14) is implemented; issues #15–#16 track
remaining order-lifecycle and position-reconciliation blockers before demo execution. No broker calls or service activation were performed. Preserve
