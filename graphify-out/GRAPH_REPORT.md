...
## Corpus Check
- 113 files · ~82,118 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 14 file(s) not represented in the graph (top: (none) 6, .service 4, .example 1)

## Summary
- 1868 nodes · 5210 edges · 90 communities (76 shown, 14 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 284 edges (avg confidence: 0.92)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5e322325`
...
### Community 0 - "_download_with_retry"
Cohesion: 0.25
Nodes (6): test_data_update_does_not_retry_auth_errors(), download(), test_data_update_retries_transient_failures(), _download_with_retry(), Any, Transient-failure retry around a scheduled data download; auth errors are…
...
Cohesion: 0.09
Nodes (22): test_postgres_connection_uses_configured_read_committed(), client(), parametrize, test_firecrawl_only_fetches_allow_listed_https_sources_and_records_provenance(), test_firecrawl_rejects_unscoped_or_sensitive_source_urls(), test_firecrawl_star_domain_allow_allows_any_https_source(), test_firecrawl_star_domain_still_rejects_insecure_or_credential_urls(), test_firecrawl_tool_marks_content_as_untrusted_and_applies_content_limit() (+14 more)
...
### Community 12 - "synthetic_bars"
Cohesion: 0.11
Nodes (31): test_all_baseline_signals_are_aligned_and_bounded(), test_breakout_channel_excludes_current_bar(), test_campaign_writes_reproducible_manifest(), test_features_do_not_change_when_future_bars_are_appended(), test_novel_signal_formulas_are_causal(), test_dynamic_parameters_change_signal(), test_quantitative_families_are_causal_and_generate_scenarios(), test_session_momentum_warmup_is_flat_not_an_integer_cast_error() (+23 more)

### Community 13 - "Any"
Cohesion: 0.11
Nodes (17): test_market_data_age_clamps_a_still_forming_bar_to_zero(), test_market_data_age_counts_from_bar_close_not_bar_open(), handler(), CockroachPaperTradingStore, _default_state(), market_data_age_seconds(), market_is_open(), _now() (+9 more)
...
### Community 15 - "HistoricalDataStore"
Cohesion: 0.22
Nodes (17): downloader_config(), minute_60(), one_bar_at(), test_download_does_not_retry_non_token_auth_error(), fake_fetch(), test_download_retries_once_on_invalid_token(), fake_fetch(), test_download_without_refresh_token_raises_instead_of_retrying() (+9 more)

### Community 16 - "ExecutionConfig"
Cohesion: 0.10
Nodes (41): ML governance and drift controls — 2026-08-21, HistGradientBoostingClassifier, ndarray, numpy, pandas, sklearn_metrics, main(), Secret-free deterministic parity fixture for the runtime container. (+33 more)
...
Cohesion: 0.18
Nodes (27): agent_runner(), fresh_paper(), fresh_source(), market_store(), paper_only_coordinator(), refresh_config(), stale_market_store(), test_assistant_steps_carry_parsed_action_and_human_reason() (+19 more)

### Community 19 - "PaperTrading"
Cohesion: 0.13
Nodes (30): test_agent_controller_refuses_on_corrupt_state(), test_agent_resume_refused_after_operator_stop_writes_status(), test_demo_automation_paper_only_skips_broker_dependencies(), test_paper_start_overrides_operator_stop(), test_paper_stop_persists_kill_switch(), decision(), test_corrupt_memory_state_fails_closed(), test_default_gate_accepts_the_newest_closed_m1_bar() (+22 more)
...
Cohesion: 0.12
Nodes (11): paper_trading(), fixture, server(), test_age_seconds_parses_timezone_aware_timestamps(), test_health_degrades_when_ticks_never_reach_the_planner(), test_health_does_not_alert_below_the_stale_tick_threshold(), test_paper_endpoint_reflects_accepted_fill(), _write_heartbeat() (+3 more)

### Community 22 - "test_offline.py"
Cohesion: 0.21
...
### Community 25 - "cli.py"
Cohesion: 0.22
Nodes (19): collections, dataclasses, datetime, hashlib, json, logging, math, os (+11 more)
...
Cohesion: 0.26
Nodes (5): DemoAutomationRunner, Any, datetime, Poll injected sources only after explicit enablement and reconciliation., Reconcile first, then make the explicitly enabled paper/demo pair runnable.
...
Cohesion: 0.06
Nodes (42): Bits agent instructions, Configuration, Datadog Bits connection, Runtime and recovery, Verified transport and remaining integration, PathLike, Architecture, Autonomous Agent (+34 more)

### Community 31 - "InMemoryAgentTranscriptStore"
Cohesion: 0.10
...
### Community 39 - "trendbars_to_frame"
Cohesion: 0.28
Nodes (5): test_trendbar_delta_decoding(), Any, DataFrame, Decode cTrader's low-plus-delta trendbar representation., trendbars_to_frame()
...
### Community 41 - "test_bits_runner.py"
Cohesion: 0.23
...
Cohesion: 0.05
Nodes (48): contextlib, fcntl, re, main(), call(), Two-invocation, no-trading smoke test of Bits -> shell -> Bits. Run from the…, selectors, signal (+40 more)

### Community 50 - "SQLiteAgentTranscriptStore"
Cohesion: 0.11
Nodes (20): Connection, pytest, Row, decision(), test_sqlite_integrity_check_detects_corruption(), test_sqlite_paper_store_corrupt_state_fails_closed(), test_sqlite_paper_store_integrity_check_reports_ok(), test_sqlite_paper_store_kill_switch_persists_and_fails_closed() (+12 more)

### Community 51 - "main"
Cohesion: 0.13
Nodes (19): Engineering, test_demo_automation_disabled_returns_status_without_constructing_clients(), test_demo_automation_status_reports_paper_only_flag(), test_state_integrity_backup_restore_round_trip(), test_agent_transcript_backend_selection_defaults_to_local(), agent_transcript_store_from_env(), Transcript store for the configured backend (local SQLite by default)., agent_controller() (+11 more)
...
### Community 53 - "CodexImprovementWorkflow"
Cohesion: 0.08
Nodes (31): Portfolio and regime research — 2026-08-21, repository(), test_codex_child_environment_uses_allowlist(), test_prepare_creates_detached_review_only_worktree(), test_prompt_has_explicit_safety_boundaries(), test_research_brief_is_redacted_and_aggregated(), test_effective_bets_detect_perfect_correlation(), test_equity_metrics_measure_portfolio_drawdown() (+23 more)
...
Cohesion: 0.13
Nodes (19): test_paper_state_tool_summary_default(), test_runner_heartbeat_tracks_consecutive_errors(), threading, uuid, build_agent_registry(), canary_signal_tool(), _decision_id(), paper_state_tool() (+11 more)

### Community 56 - "test_validation.py"
Cohesion: 0.15
Nodes (18): test_block_bootstrap_preserves_clustered_sequence_effect(), test_bootstrap_is_seeded_and_reports_loss_probability(), test_bootstrap_rejects_invalid_configuration(), test_parameter_neighbors_change_one_value(), test_validator_writes_report_and_does_not_promote_weak_strategy(), validate_strategy(), bootstrap_trade_paths(), chronological_split() (+10 more)

### Community 57 - "TournamentDataset"
Cohesion: 0.17
Nodes (12): Dependence-aware bootstrap validation — 2026-08-21, setup_runner(), test_failure_is_durable(), test_legacy_flat_parameters_are_reconstructed(), test_robust_validation_adds_walk_forward_and_bootstrap(), test_worker_completes_and_writes_artifacts_without_test_partition(), frame_digest(), DataFrame (+4 more)

### Community 58 - "CTraderOpenApiDownloader"
Cohesion: 0.39
...
Cohesion: 0.29
Nodes (6): Autonomous Harness, Datadog Bits operations, Execution Boundary, graphify, Purpose, Repository Operating Rules
...
Cohesion: 0.11
Nodes (19): Operations, FastAPI, fastapi_responses, test_invalid_backend_raises(), test_paper_from_env_defaults_to_local_sqlite_store(), read(), create_app(), data_update_status() (+11 more)

### Community 79 - "CTraderDemoStore"
Cohesion: 0.15
Nodes (3): CTraderDemoStore, CTraderTransport, Protocol

### Community 80 - "CTraderOpenApiConfig"
Cohesion: 0.33
Nodes (5): demo_env(), test_data_config_from_env_account_optionally_discovered(), test_data_config_rejects_non_demo_host(), test_data_config_requires_demo_only_flag(), CTraderOpenApiConfig

### Community 82 - "core.py"
Cohesion: 0.27
Nodes (8): test_backtest(), campaign(), event_backtest(), BacktestConfig, Backtester, features(), DataFrame, Series

### Community 87 - "_paper_to_demo_coordinator"
Cohesion: 0.15
...
### Community 93 - "_demo_automation_runner"
Cohesion: 0.29
Nodes (8): test_demo_automation_requires_explicit_positive_volume(), test_environment_config_is_disabled_unless_explicitly_true(), demo_automation(), _demo_automation_runner(), _demo_automation_status(), _positive_env_float(), Run the explicitly enabled local-data paper-to-demo canary., DemoRunnerConfig
...
- **Why does `XAUUSD discovery, incident, quantitative, and scaling audit` connect `XAUUSD discovery, incident, quantitative, and scaling audit` to `test_search_space.py`, `AdaptiveSearch`, `test_weekly_report.py`, `ExecutionConfig`, `CodexImprovementWorkflow`, `TournamentDataset`, `RemoteComputeBridge`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `MemoryRegistry` connect `MemoryRegistry` to `test_search_space.py`, `memory_registry.py`, `dashboard.py`, `OperationsManager`, `AdaptiveSearch`, `synthetic_bars`, `test_weekly_report.py`, `CodexImprovementWorkflow`, `ShadowTradingReadiness`, `TournamentDataset`, `RemoteComputeBridge`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `HistoricalDataStore` connect `HistoricalDataStore` to `ConfirmedBreakoutCanarySource`, `trendbars_to_frame`, `synthetic_bars`, `ExecutionConfig`, `CTraderOpenApiConfig`, `test_agent_loop.py`, `main`, `automation.py`, `core.py`, `agent_loop.py`, `test_validation.py`, `cli.py`, `_demo_automation_runner`, `/graphify`, `TournamentDataset`?**
