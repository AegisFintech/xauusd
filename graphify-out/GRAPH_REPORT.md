...
## Corpus Check
- 107 files · ~78,217 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 14 file(s) not represented in the graph (top: (none) 6, .service 4, .example 1)

## Summary
- 1782 nodes · 4909 edges · 84 communities (71 shown, 13 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 240 edges (avg confidence: 0.93)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bda42548`
...
Cohesion: 0.14
Nodes (27): paper_trading(), test_agent_controller_refuses_on_corrupt_state(), test_demo_automation_paper_only_skips_broker_dependencies(), decision(), test_corrupt_memory_state_fails_closed(), test_default_gate_accepts_the_newest_closed_m1_bar(), test_duplicate_decision_returns_persisted_outcome_without_second_fill(), test_gate_returns_market_closed_outside_trading_hours() (+19 more)

### Community 1 - "test_autonomous_harness.py"
Cohesion: 0.05
Nodes (48): 10. Alternatives and fallback, 11. Recommendation, 12. Status of evidence, 1. Context and goal, 2. Feasibility verdict, 3. Where the planner is wired today (confirmed), 4. Datadog capabilities relevant to this swap (confirmed from Datadog docs), 5. Target architecture (+40 more)
...
Cohesion: 0.07
Nodes (16): ExperimentStatus, test_postgres_connection_uses_configured_read_committed(), CockroachHarnessStore, _now(), canonical_json(), ExperimentRegistry, PostgresConnection, Any (+8 more)
...
Cohesion: 0.16
Nodes (21): main(), Secret-free deterministic parity fixture for the runtime container., bars(), no_costs(), test_array_loop_is_deterministic_on_randomized_path(), test_compact_attribution_metrics_reconcile_and_measure_concentration(), test_signal_executes_at_next_open_without_lookahead(), test_spread_slippage_and_commission_are_charged_both_sides() (+13 more)

### Community 13 - "synthetic_bars"
Cohesion: 0.17
Nodes (20): test_all_baseline_signals_are_aligned_and_bounded(), test_breakout_channel_excludes_current_bar(), test_features_do_not_change_when_future_bars_are_appended(), test_novel_signal_formulas_are_causal(), test_dynamic_parameters_change_signal(), test_quantitative_families_are_causal_and_generate_scenarios(), test_session_momentum_warmup_is_flat_not_an_integer_cast_error(), dataset() (+12 more)
...
### Community 17 - "Any"
Cohesion: 0.11
Nodes (8): request(), failed(), issue(), succeeded(), CTraderDemoStore, Any, Read-only broker volume/price metadata for the resolved demo symbol., Return ``(code, description)`` for a cTrader error message, else None.
...
Cohesion: 0.15
Nodes (18): test_block_bootstrap_preserves_clustered_sequence_effect(), test_bootstrap_is_seeded_and_reports_loss_probability(), test_bootstrap_rejects_invalid_configuration(), test_chronological_splits_are_ordered_and_disjoint(), test_parameter_neighbors_change_one_value(), test_walk_forward_never_trains_on_future(), validate_strategy(), bootstrap_trade_paths() (+10 more)

### Community 20 - "test_weekly_report.py"
Cohesion: 0.17
...
Cohesion: 0.15
Nodes (6): test_age_seconds_parses_timezone_aware_timestamps(), test_health_degrades_when_ticks_never_reach_the_planner(), test_health_does_not_alert_below_the_stale_tick_threshold(), test_paper_endpoint_reflects_accepted_fill(), _write_heartbeat(), _age_seconds()

### Community 22 - "TournamentDataset"
Cohesion: 0.18
Nodes (11): setup_runner(), test_failure_is_durable(), test_legacy_flat_parameters_are_reconstructed(), test_robust_validation_adds_walk_forward_and_bootstrap(), test_worker_completes_and_writes_artifacts_without_test_partition(), frame_digest(), DataFrame, Hash canonical timestamps, schema, and values independent of Parquet bytes. (+3 more)
...
### Community 25 - "cli.py"
Cohesion: 0.16
Nodes (29): collections, concurrent_futures, dataclasses, datetime, hashlib, json, logging, math (+21 more)

### Community 26 - "ConfirmedBreakoutCanarySource"
Cohesion: 0.15
Nodes (23): append_bars(), newest_market(), Signal generator emitting one SELL transition at an absolute bar time. The…, store_with_bars(), test_canary_cold_start_ignores_a_transition_it_never_observed(), test_canary_drops_a_transition_beyond_the_backlog_bound(), test_canary_emits_each_transition_once(), test_canary_ignores_neutral_and_persistent_signals() (+15 more)

### Community 27 - "pytest"
Cohesion: 0.19
Nodes (14): pytest, test_offline_transitions_are_aligned_and_terminal(), test_sequence_windows_never_include_future_rows(), test_torch_adapter_explains_missing_extra(), build_offline_transitions(), build_sequence_dataset(), OfflineTransitions, DataFrame (+6 more)
...
### Community 33 - "paper_trading.py"
Cohesion: 0.14
Nodes (21): FastAPI, fastapi_responses, decision(), test_invalid_backend_raises(), test_paper_from_env_defaults_to_local_sqlite_store(), test_sqlite_integrity_check_detects_corruption(), test_sqlite_paper_store_corrupt_state_fails_closed(), test_sqlite_paper_store_integrity_check_reports_ok() (+13 more)

### Community 34 - "memory_registry.py"
Cohesion: 0.18
Nodes (3): copy, MemoryConnection, MemoryCursor

### Community 35 - "DemoAutomationRunner"
Cohesion: 0.30
...
### Community 38 - "Any"
Cohesion: 0.14
Nodes (8): _default_state(), PaperDecision, transition(), PaperTradingStore, Any, datetime, Protocol, Computed, display-only paper results for the live view.

### Community 39 - "core.py"
Cohesion: 0.27
Nodes (8): test_backtest(), campaign(), event_backtest(), BacktestConfig, Backtester, features(), DataFrame, Series

### Community 40 - "Repository Operating Rules"
Cohesion: 0.20
...
Cohesion: 0.21
Nodes (16): envelope(), parametrize, shell_action(), test_refuses_invalid_envelopes(), test_refuses_invalid_shell_limits(), test_strict_json_and_arbitrary_command(), test_transport_submission_and_polling(), BitsClient (+8 more)
...
### Community 51 - "PaperRiskConfig"
Cohesion: 0.15
Nodes (24): gzip, sqlite3, decision(), seeded_db(), test_backup_keeps_validating_wal_writes(), test_backup_refuses_corrupt_source(), test_backup_restore_round_trip_preserves_state(), test_restore_refuses_garbage_archive() (+16 more)
...
### Community 53 - "test_portfolio_research.py"
Cohesion: 0.26
...
### Community 54 - "HistoricalDataStore"
Cohesion: 0.09
Nodes (34): test_data_update_does_not_retry_auth_errors(), download(), demo_env(), downloader_config(), minute_60(), one_bar_at(), test_data_config_from_env_account_optionally_discovered(), test_data_config_rejects_non_demo_host() (+26 more)

### Community 55 - "agent_loop.py"
Cohesion: 0.12
Nodes (25): threading, build_agent_registry(), canary_signal_tool(), handler(), _decision_id(), _mock_market_for_read(), paper_state_tool(), _positive_float() (+17 more)

### Community 56 - "StrategySpec"
Cohesion: 0.28
Nodes (5): StrategySpec, _finite(), Path, Consume deterministic experiments without reading the holdout test set., TournamentRunner
...
Cohesion: 0.18
Nodes (10): fixture, server(), test_portfolio_run_reads_validation_only(), read(), create_app(), data_update_status(), health(), index() (+2 more)
...
### Community 62 - "test_experiment_registry.py"
Cohesion: 0.26
...
### Community 64 - "test_strategy_proposals.py"
Cohesion: 0.25
Nodes (7): test_novel_formulas_generate_valid_signals(), test_proposal_catalog_eventually_exhausts(), test_adaptive_generations_wait_for_completion_interval(), novel_proposals(), Proposal, ProposalEngine, ContinuousTournamentWorker
...
Cohesion: 0.09
Nodes (20): test_recovery_failure_kills_and_blocks_execution(), test_symbol_metadata_and_volume_policy_validate_invariants(), build_new_order_request(), build_reconcile_request(), CTraderDemoAdapter, CTraderDemoSafetyError, CTraderOrder, CTraderSymbolMetadata (+12 more)
...
### Community 75 - "main"
Cohesion: 0.09
Nodes (24): test_agent_resume_refused_after_operator_stop_writes_status(), test_data_update_retries_transient_failures(), test_demo_automation_disabled_returns_status_without_constructing_clients(), test_demo_automation_requires_explicit_positive_volume(), test_demo_automation_status_reports_paper_only_flag(), test_paper_start_overrides_operator_stop(), test_paper_stop_persists_kill_switch(), test_state_integrity_backup_restore_round_trip() (+16 more)
...
### Community 78 - "mutation_analytics"
Cohesion: 0.33
...
- **Why does `XAUUSD discovery, incident, quantitative, and scaling audit` connect `XAUUSD discovery, incident, quantitative, and scaling audit` to `ExperimentSpec`, `AdaptiveSearch`, `RemoteComputeBridge`, `mutation_analytics`, `test_ml.py`, `test_weekly_report.py`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `PaperTrading` connect `PaperTrading` to `paper_trading.py`, `test_demo_execution.py`, `test_demo_runner.py`, `Any`, `Repository Operating Rules`, `main`, `PaperToCTraderDemoCoordinator`, `_paper_to_demo_coordinator`, `test_agent_loop.py`, `PaperRiskConfig`, `test_agent_view.py`, `agent_loop.py`, `cli.py`, `create_app`, `ContinuousAgentRunner`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `ExperimentRegistry` connect `ExperimentRegistry` to `ExperimentSpec`, `test_strategy_proposals.py`, `OperationsManager`, `dashboard.py`, `RemoteComputeBridge`, `AdaptiveSearch`, `main`, `.__init__`, `test_weekly_report.py`, `TournamentDataset`, `ShadowTradingReadiness`, `StrategySpec`, `cli.py`, `CodexImprovementWorkflow`, `test_experiment_registry.py`?**
